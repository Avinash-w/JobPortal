    ...
    const handleUpload = async ()=>{
        ...
        try {
            ...
            if (res.ok) {
                ...
                window.location.reload(); // to reflect the new image
            } else {
                alert("Upload failed.");
            }
        } catch (error) {
...
_s(PersonalDetails, "cz3B5sQOxlrekAnUFUPeMaA2gqY=");
_c = PersonalDetails;
var _c;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60f6ba11._.js.map