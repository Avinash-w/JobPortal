    ...
    form.parse(req, async (err, fields, files)=>{
        if (err) {
            ...
            return res.status(500).json({
                error: "Upload failed during parsing"
            });
        }
        const { userId } = fields;
        ...
        const imageName = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(uploadedFile.filepath);
        const imagePath = "/uploads/" + imageName;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(userId, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8626258b._.js.map